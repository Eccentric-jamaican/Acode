    ...
    <div className="relative">
      <PlainTextPlugin
        contentEditable={
          <ContentEditable
            className={cn(
              "block max-h-[180px] min-h-12 w-full overflow-y-auto whitespace-pre-wrap break-words bg-transparent text-[14px] leading-[1.45] text-foreground focus:outline-none",
              className,
            )}
        ...
        placeholder={
          <div className="pointer-events-none absolute inset-0 text-[14px] leading-[1.45] text-muted-foreground/35">
            {placeholder}
          </div>
        }
