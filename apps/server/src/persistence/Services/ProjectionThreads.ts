...
export const ProjectionThread = Schema.Struct({
  threadId: ThreadId,
  projectId: ProjectId,
  origin: Schema.Literals(["user", "task"]),
  taskId: Schema.NullOr(TaskId),
  parentThreadId: Schema.NullOr(ThreadId),
  subagentAgentId: Schema.NullOr(Schema.String),
  subagentNickname: Schema.NullOr(Schema.String),
  subagentRole: Schema.NullOr(Schema.String),
  title: Schema.String,
  model: Schema.String,
